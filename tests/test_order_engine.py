...
def test_place_a_trade_in_mock_engine():
    ...
    new_order_engine = OrderEngine()
    new_order = new_order_engine.place(
        symbol=symbol, side=side, quantity=quantity, price=price, type=order_type
    )
