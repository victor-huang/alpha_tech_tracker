...
def test_add_a_position():
    ...
    new_portfolio.add_position(
        symbol=symbol, open_price=open_price, quantity=quantity, open_order_id="1"
    )
...
def test_close_a_position():
    ...
    new_portfolio.close_position(
        id=position_id, close_price=close_price, close_order_id="1"
    )
...
def test_close_a_invalid_position():
    ...
    position = new_portfolio.close_position(
        id="not_exist", close_price=close_price, close_order_id="1"
    )
...
def test_calculate_pnl():
    ...
    google_position = new_portfolio.add_position(
        symbol="GOOGL", open_price=100, quantity=1, open_order_id="2"
    )
    ...
    new_portfolio.close_position(
        id=google_position.id, close_price=110, close_order_id="2"
    )
...
def test_bucket_positions_pnl_by_time():
    ...
    for index, p in enumerate(new_portfolio.positions[0:2]):
        ...
        new_portfolio.close_position(
            id=p.id, closed_at=close_at, close_price=2, close_order_id=p.open_order_id
        )
    ...
    for index, p in enumerate(new_portfolio.positions[2:4]):
        ...
        new_portfolio.close_position(
            id=p.id, closed_at=close_at, close_price=10, close_order_id=p.open_order_id
        )
    ...
    for index, p in enumerate(new_portfolio.positions[4:6]):
        ...
        new_portfolio.close_position(
            id=p.id, closed_at=close_at, close_price=20, close_order_id=p.open_order_id
        )
