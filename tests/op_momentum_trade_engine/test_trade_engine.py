...
from alpha_tech_tracker.op_momentum_strategy.config import MAX_ACTIVE_SYMBOLS, RANK_WEIGHTS
...
_PLACE_ENTRY_PATH = (
    "alpha_tech_tracker.op_momentum_strategy.trade_engine.OpMomentumTradeEngine._place_entry"
)
