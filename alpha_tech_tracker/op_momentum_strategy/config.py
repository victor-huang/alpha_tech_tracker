...
STOP_PCT = _D("0.15")
STRIKE_CALL_OFFSET = _D("0.92")
STRIKE_PUT_OFFSET = _D("1.08")
...
BAR_AGG_GRACE_SECONDS = 90
TRAILING_MA = "ma20"
TRAILING_MA_SWITCH = "none"
TRAILING_MA_SWITCH_FACTOR = 1.0
TRAILING_MA_SWITCH_PERIOD = 8
MAX_LOSS_PCT = None
DAILY_MAX_LOSS_USD = 5000
WS_RECONNECT_TIMEOUT_SECONDS = 600
