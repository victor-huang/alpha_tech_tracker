...
#
# Usage:
#   ./run_replay_stock_5win.sh --year 2025
#   ./run_replay_stock_5win.sh --year 2026 --summary
#   ./run_replay_stock_5win.sh --year 2025 --force
...
LOG_DIR="$BASE_LOG_DIR/replay_${YEAR}_${TRADE_TYPE}_5win"
...
print()
print(f"=== {year} Stock Replay — M1 09:30/3 + A1 10:00/3 + A2 11:45/2 + A3 13:15/1 + A4 15:15/1 ===")
print(f"    reversal | bearish-reentry | bullish-reentry | DD@10 | rank-weighted 60/40 | top2 | $10k")
print()
...
echo ""
echo "=== $YEAR $TRADE_TYPE replay (5-window: M1+A1+A2+A3+A4) ==="
