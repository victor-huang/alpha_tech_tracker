...
- **Hard stop**: exit at midpoint if price crosses it (bullish below, bearish above)
- **Priority**: midpoint is checked first within each bar, MA50 second
- **Success threshold**: trade must hold correct side of midpoint for ≥ 15 min (3 bars)
...
| 2010–2019 | Long low-vol bull | Not yet | Decade-long grind with minimal drawdowns — tests signal in calm, persistently trending markets |
...
| 2015–2016 | China slowdown / oil crash | Not yet | Commodity sector stress alongside tech resilience; good for testing energy tickers |
...
| Round | Category | COVID crash | 2020 full yr | 2022 (bear) | 2023–24 (AI bull) | 2025–26 (up) |
|---|---|---|---|---|---|---|
| 1 | SaaS / Cloud | +$4 | +$172 | **+$537** | +$258 | +$96 |
| 2 | Consumer Tech | -$19 | +$134 | **+$425** | +$119 | +$120 |
| 3 | Semiconductors | -$12 | -$4 | +$188 | **+$717** | +$145 |
| 4 | Defensives | -$24 | +$24 | +$34 | +$112 | +$105 |
| 5 | Speculative | +$54 | **+$394** | +$256 | +$682 | +$287 |
| **Total** | **+$4** | **+$719** | **+$1,440** | **+$1,889** | **+$753** |
