...
# NOTE: fetch_bars / select_top_n / compute_signals_with_backtest /
# compute_directional_stats / rank_tickers_direction_aware /
# _rank_tickers_by_eod_win_rate moved to selectors.py along with the two
# TickerSelector classes — patch them at op_momentum_strategy.selectors.*
from alpha_tech_tracker.op_momentum_strategy.regime_engine import RegimeEngine
...
from .selectors import (  # noqa: F401  — re-exported; imported from here by tests
    TickerSelector,
